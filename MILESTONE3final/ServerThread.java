...
public class ServerThread extends Thread{
	...
	TCPServer server;
	public ServerThread(Socket myClient, String clientName, TCPServer server) throws IOException {
	...
	void processPayload(Payload payload) {
		...
		switch(payload.payloadType) {
			...
			case CHOICE:
				...
				server.displayPoints();
				break;
			case GUESS:
				//Handles a guess
				server.HandleGuess(clientName,payload.message);
			default:
				break;
		}
	}
